...
CFG.LEMMA.WARMUP = 150
CFG.LEMMA.STOP = 180
CFG.LEMMA.EMA_STEP = 1
CFG.LEMMA.EMA_RANGE = [0.999, 0.9]
CFG.LEMMA.STRATEGY = 'attn'  # 'const', 'lin', 'cos', 'negcos', 'attn', 'rand'
CFG.LEMMA.RESET = []
CFG.LEMMA.ATTN = CN()
CFG.LEMMA.ATTN.DIM = 768
CFG.LEMMA.ATTN.FC_LAYER = True
CFG.LEMMA.ATTN.LOSS_WEIGHT = 0.2
CFG.LEMMA.ATTN.LOSS_DECAY = 'none' # 'none', 'exp', 'jump', 
CFG.LEMMA.ATTN.LOSS_DECAY_RATIO = 0.05
CFG.LEMMA.ATTN.LOSS_WEIGHT_JUMP = 0.
CFG.LEMMA.ATTN.SIGMOID = True
CFG.LEMMA.ISOLATE = False
CFG.LEMMA.LOGIT_AUG = CN()
CFG.LEMMA.LOGIT_AUG.ENABLE = True 
CFG.LEMMA.LOGIT_AUG.STRATEGY = 'lin-rand'  # 'const-rand', 'lin-rand', 'attn', 'normal'
CFG.LEMMA.LOGIT_AUG.RANGE = [0.1, 0.0]
CFG.LEMMA.LOGIT_AUG.ATTN = 128
CFG.LEMMA.LOGIT_AUG.TRANSMIT = False
CFG.LEMMA.LOGIT_AUG.STOP = -1
CFG.LEMMA.LOGIT_AUG.NOISE = 1.0E-2
CFG.LEMMA.SAVE_LOGIT = 0
CFG.LEMMA.ADAM = CN()
CFG.LEMMA.ADAM.ENABLE = False
CFG.LEMMA.ADAM.BETAS = (0.9, 0.999)
CFG.LEMMA.ADAM.EPS = 1.0E-8
CFG.LEMMA.REPLICAS = CN()
CFG.LEMMA.REPLICAS.CARDINALITY = 0 
CFG.LEMMA.REPLICAS.JITTER = 1.0E-3 
CFG.LEMMA.SAVE_LOGIT = 0

CFG.LEMMA.ATTN.V_LAYER = False
